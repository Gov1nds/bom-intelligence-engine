...
# Base cost ranges per category (USD per unit, for quantity=1)
CATEGORY_BASE_COSTS = {
    "fastener": (0.02, 0.50),
    "electrical": (0.50, 15.0),
    "electronics": (0.10, 25.0),
    "mechanical": (5.0, 150.0),
    "raw_material": (2.0, 80.0),
    "sheet_metal": (10.0, 200.0),
    "machined": (15.0, 500.0),
    "custom_mechanical": (20.0, 800.0),
    "pneumatic": (5.0, 100.0),
    "hydraulic": (10.0, 200.0),
    "optical": (5.0, 300.0),
    "thermal": (3.0, 80.0),
    "cable_wiring": (2.0, 50.0),
    "standard": (1.0, 50.0),
    "unknown": (1.0, 100.0),
}
...
def estimate_cost(category: str, material: str, quantity: float, is_custom: bool, has_mpn: bool) -> dict:
    ...
    # Catalog discount if MPN available
